...
?>
     ...
     <div >
         ...
         <?php while($row_news=mysqli_fetch_assoc($news)){ ?>
          <h3><a href="views/web_site/news.php?news_id=<?php echo $row_news['news_id'];?>"><?php echo $row_news['title'];?></a></h3>
       ...
       <div>
         ...
         <?php while($row_service=mysqli_fetch_assoc($service)){ ?>
          <h3><a href="views/web_site/service.php?service_id=<?php echo $row_service['service_id'];?>"><?php echo $row_service['service_name'];?></a></h3>
