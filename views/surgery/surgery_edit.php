...
<?php
	 ...
	 checkLevel(4, 9, 9, 9, 9, 4, 9, 9, 9, 9);	
    // getting departments 
	...
	if(isset($_POST["surgery_name"])) {
		...
		$result = mysqli_query($con, "UPDATE surgery SET surgery_name='$surgery_name', department_id= $department_id,price=$price ,currency='$currency' WHERE surgery_id=$surgery_id");
		...
		<form method="post">
		    ...
		    <div class="input-group">
				...
				<select name="currency" class="form-control">
					<option <?php if($row_surgery['currency']=='AFG'){echo "selected";} ?> >AFG</option>
					<option <?php if($row_surgery['currency']=='USD'){echo "selected";}?> >USD</option>
				</select>
			</div>
