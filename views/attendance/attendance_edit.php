...
<?php
	...
	if(isset($_POST["absent_date"])) {
		...
		$result = mysqli_query($con, "UPDATE attendance SET staff_id=$staff_id, absent_year=$year, absent_month=$month, absent_day=$day, hours=$hours WHERE staff_id = $staff_id AND absent_year = $absent_year AND absent_month = $absent_month AND absent_day = $absent_day");
