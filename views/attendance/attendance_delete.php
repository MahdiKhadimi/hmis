<?php
	...
	$result = mysqli_query($con, "DELETE FROM attendance WHERE staff_id = $staff_id AND absent_year = $absent_year AND absent_month = $absent_month AND absent_day = $absent_day");
