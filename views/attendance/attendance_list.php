...
<?php
	...
	$attendance = mysqli_query($con, "SELECT *, (SELECT SUM(hours) FROM attendance WHERE staff_id = staff.staff_id AND absent_month = $month AND absent_year = $year) AS totalhours FROM staff");
