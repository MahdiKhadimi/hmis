...
<?php
	...
	;	
		...
		if($_FILES["photo"]["name"] != "") { 
			...
			if($gender == 0) {
				$path = "../../images/history/user_m.png";
			}
			else {
				$path = "../../images/history/user_f.png";
			}
		}
		...
		$result =mysqli_query($con, "INSERT INTO history VALUES (NULL, '$title', '$description','$path')");
	 
		if($result) {
			header("location:history_list.php?add=done");
		}
		else {
			header("location:history_add.php?error=notadd");
		}
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input type="submit" value="Register history" class="btn btn-primary">
